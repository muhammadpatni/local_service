...
import 'package:image_picker/image_picker.dart';
import 'package:image_cropper/image_cropper.dart';
import 'provider_document_screen.dart'; // Next Screen
...
class _ProviderProfileSettingsScreenState
  ...
  TextEditingController experienceController =
      TextEditingController(); // NEW: Experience
  ...
  void _goToNextScreen() {
    ...
    if (nameController.text.trim().isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
            "Name, Experience, and at least 1 Service are mandatory!",
          ),
        ),
      );
      return;
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => ProviderDocumentScreen(
          ...
          phone: phoneController.text.trim(),
          email: emailController.text.trim(),
          experience: experienceController.text.trim(), // Passing Experience
          services: selectedServices,
        ),
      ),
    );
        ...
        child: Column(
          ...
          children: [
            ...
            _buildTextField(
              ...
              "e.g. 5 Years",
              isPhone: true,
            ), // Using number pad for experience usually
