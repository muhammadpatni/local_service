...
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:local_service/login_screen.dart'; // Added
import 'package:local_service/user_profile_setting_screen.dart';
...
class _SelectionScreenState extends State<SelectionScreen> {
  ...
  // Undo Process Logic: User ko logout kardo agar wo back press karta hai
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      // Black screen rokne aur Undo process ke liye
      canPop: false,
      onPopInvoked: (didPop) {
        if (didPop) return;
        _cancelAndLogout();
      ...
      child: Scaffold(
        backgroundColor: Colors.white,
        appBar: AppBar(
          // Appbar lagaya taake UI se bhi back ja sake
          backgroundColor: Colors.white,
          elevation: 0,
          leading: IconButton(
                            ...
                            child: Column(
                              children: [
                                _buildButton(
                                  ...
                                  onPressed: () {
                                    Navigator.push(
                                      // Push instead of replacement so back works
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            UserProfileSettingsScreen(
