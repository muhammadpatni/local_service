...
import 'package:flutter/material.dart';
import 'package:google_fonts/google_fonts.dart';
import 'package:local_service/home_page.dart'; // Added
import 'package:local_service/selection_screen.dart';
import 'package:pinput/pinput.dart';
...
class _OtpScreenState extends State<OtpScreen> {
  final TextEditingController otpController = TextEditingController();
  final Color primaryBlue = const Color(0xFF0E6BBB);
  bool _isLoading = false; // Added Loader

  @override
  Widget build(BuildContext context) {
    final screenWidth = MediaQuery.of(context).size.width;
    final boxWidth = (screenWidth - 80) / 6;
      ...
      if (user != null) {
        ...
        if (userDoc.exists) {
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  SelectionScreen(emailcontact: widget.contact),
            ),
          );
        }
      }
